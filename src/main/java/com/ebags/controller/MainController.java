...
*/
	...
	ModelAndView storeproduct(HttpServletRequest request, @RequestParam("file") MultipartFile file,
		...
		if (!file.isEmpty()) {
			try {
				...
				BufferedOutputStream buffStream = new BufferedOutputStream(new FileOutputStream(
						new File("E:/dtjava/newnet/ebags/src/main/webapp/resources/images" + fileName)));
		...
		File oldName = new File("E:/dtjava/newnet/ebags/src/main/webapp/resources/images"+ fileName);
		File newName = new File("E:/dtjava/newnet/ebags/src/main/webapp/resources/images"+ p.getPid()
