...
<body background="resources/images/bg2.jpg"><div class="container" id="main">
...
<br /> <br /> <br />  
		<h1 align="center">Please Enter Product Information</h1>
<form:form   	commandName="ebags" action="saveproduct" >
