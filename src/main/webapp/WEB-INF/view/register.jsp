...
<br/>
<br/>
<h3 align="center"><font color="yellow">User Registration</font></h3>
<br/><br/>

<form:form method="POST"  commandName="regvalidation" action="saveregistration">
<font color="lightblues">
<table align="center">
<tr> <td><br/> <form:label path="fname">Firstname:</form:label></td><td><form:input path="fname" value="" /></td><td><font color="RED"><form:errors path="fname" /></font></td></tr>
<tr> <td><br/> <form:label path="lname">Lastname:</form:label></td><td><form:input path="lname" value="" /></td><td><font color="RED"><form:errors path="lname" /></font></td></tr>
<tr> <td><br/> <form:label path="email">Email:</form:label></td><td><form:input path="email" value="" /></td><td><font color="RED"><form:errors path="email" /></font></td></tr>
<tr> <td><br/> <form:label path="phone">Phone:</form:label></td><td><form:input path="phone" value="" /></td><td><font color="RED"><form:errors path="phone" /></font></td></tr>
<tr> <td><br/> <form:label path="uname">User Name:</form:label></td><td><form:input path="uname" value=""/></td><td><font color="RED"><form:errors path="uname" /></font></td></tr>
 <tr> <td><br/> <form:label path="pwd">Password:</form:label></td><td><form:input path="pwd" value=""/></td><td><font color="RED"><form:errors path="pwd" /></font></td></tr>
